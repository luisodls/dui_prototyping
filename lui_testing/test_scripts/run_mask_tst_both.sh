...
dials.generate_mask imported.expt untrusted.circle=1251,106,512 untrusted.rectangle=909,1692,35,132,2 untrusted.circle=-251,-106,512,3  output.mask=tmp_mask.pickle
